...
<body>
    ...
    <header id="gen-header" class="gen-header-style-1 gen-has-sticky">
        ...
        <ul class="sub-menu">
        <li class="menu-item">
            <a href="single-movie.html">Trending Now</a>
        </li>
        <li class="menu-item">
            <a href="single-movie.html">New Releases</a>
        </li>
        <li class="menu-item menu-item-has-children">
            <a href="#">Action</a>
            <ul class="sub-menu">
                <li class="menu-item">
                    <a href="single-movie.html">Superhero</a>
                </li>
                <li class="menu-item">
                    <a href="single-movie.html">Adventure</a>
                </li>
                <li class="menu-item">
                    <a href="single-movie.html">Military</a>
                </li>
            </ul>
        </li>
        <li class="menu-item menu-item-has-children">
            ...
            <ul class="sub-menu">
                <li class="menu-item">
                    <a href="single-movie.html">Romantic Comedy</a>
                </li>
                <li class="menu-item">
                    <a href="single-movie.html">Dark Comedy</a>
                </li>
            </ul>
        </li>
        <li class="menu-item">
            <a href="single-movie.html">Horror</a>
        </li>
        <li class="menu-item">
            <a href="single-movie.html">Drama</a>
        </li>
        <li class="menu-item">
            <a href="single-movie.html">Romance</a>
        </li>
        <li class="menu-item">
            <a href="single-movie.html">Popular</a>
        </li>
        <li class="menu-item">
            <a href="single-movie.html">Top Rated</a>
        </li>
    </ul>
</li>
<li class="menu-item">
                ...
                <div class="col-12">
                    <div class="gen-banner-movies">
                        ...
                        <div class="owl-carousel owl-loaded owl-drag" data-dots="false" data-nav="true"
                            ...
                            <div class="item" style="background: url('images/background/asset-9.jpg')">
                            ...
                            <div class="item" style="background: url('images/background/asset-24.jpg')">
                                <div class="gen-movie-contain h-100">
                                    <div class="container h-100">
                                        <div class="row align-items-center h-100">
                                            <div class="col-xl-6">
                ...
                <div class="col-12">
                    <div class="gen-banner-movies">
                        <div class="owl-carousel owl-loaded owl-drag" data-dots="true" data-nav="false"
                            data-desk_num="1" data-lap_num="1" data-tab_num="1" data-mob_num="1" data-mob_sm="1"
                            data-autoplay="true" data-loop="true" data-margin="30">
                            <div class="item" style="background: url('images/background/asset-5.jpg')">
                                <div class="gen-movie-contain h-100">
                                    <div class="container h-100">
                                        <div class="row align-items-center h-100">
                                            <div class="col-xl-6">
                            ...
                            <div class="item" style="background: url('images/background/asset-6.jpg')">
                                <div class="gen-movie-contain h-100">
                                    <div class="container h-100">
                                        <div class="row align-items-center h-100">
                                            <div class="col-xl-6">
                            ...
                            <div class="item" style="background: url('images/background/asset-7.jpg')">
                                <div class="gen-movie-contain h-100">
                                    <div class="container h-100">
                                        <div class="row align-items-center h-100">
                                            <div class="col-xl-6">
                            ...
                            <div class="item" style="background: url('images/background/asset-8.jpg')">
                                <div class="gen-movie-contain h-100">
                                    <div class="container h-100">
                                        <div class="row align-items-center h-100">
                                            <div class="col-xl-6">
                            ...
                            <div class="item" style="background: url('images/background/asset-11.jpg')">
                                <div class="gen-movie-contain h-100">
                                    <div class="container h-100">
                                        <div class="row align-items-center h-100">
                                            <div class="col-xl-6">
                            ...
                            <div class="item" style="background: url('images/background/asset-12.jpg')">
                                <div class="gen-movie-contain h-100">
                                    <div class="container h-100">
                                        <div class="row align-items-center h-100">
                                            <div class="col-xl-6">
                            ...
                            <div class="item" style="background: url('images/background/asset-13.jpg')">
                                <div class="gen-movie-contain h-100">
                                    <div class="container h-100">
                                        <div class="row align-items-center h-100">
                                            <div class="col-xl-6">
                            ...
                            <div class="item">
                                <div
                                    ...
                                    <div class="gen-carousel-movies-style-3 movie-grid style-3">
                                        <div class="gen-movie-contain">
                                            <div class="gen-movie-img">
                                                <img src="images/background/asset-30.jpg"
                                                    alt="owl-carousel-video-image">
                                                <div class="gen-movie-add">
                                                    <div class="wpulike wpulike-heart">
                                                        <div class="wp_ulike_general_class wp_ulike_is_not_liked">
                            ...
                            <div class="item">
                                <div
                                    ...
                                    <div class="gen-carousel-movies-style-3 movie-grid style-3">
                                        <div class="gen-movie-contain">
                                            <div class="gen-movie-img">
                                                <img src="images/background/asset-31.jpg"
                                                    alt="owl-carousel-video-image">
                                                <div class="gen-movie-add">
                                                    <div class="wpulike wpulike-heart">
                                                        <div class="wp_ulike_general_class wp_ulike_is_not_liked">
                            ...
                            <div class="item">
                                <div
                                    ...
                                    <div class="gen-carousel-movies-style-3 movie-grid style-3">
                                        <div class="gen-movie-contain">
                                            <div class="gen-movie-img">
                                                <img src="images/background/asset-34.jpg"
                                                    alt="owl-carousel-video-image">
                                                <div class="gen-movie-add">
                                                    <div class="wpulike wpulike-heart">
                                                        <div class="wp_ulike_general_class wp_ulike_is_not_liked">
