                    ...
                    <div class="gen-banner-movies">
                        <div class="owl-carousel owl-loaded owl-drag" data-dots="true" data-nav="false"
                            ...
                            @foreach ($trending as $trend)
                                <div class="item" style="background: url('{{ $trend->background_image_url ?? $trend->image_url }}') no-repeat center center; background-size: cover; min-height: 500px;">
                                    <div class="gen-movie-contain h-100">
                                        <div class="container h-100">
                                            <div class="row align-items-center h-100">
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="gen-movie-meta-holder">
                                                        <ul>
                                                            ...
                                                            <li>{{ $trend->duration }}</li>
                                                            <li>
                                                                <img src="images/asset-2.png" alt="rating">
                                                                <span>{{ $trend->average_rating ?? 'N/A' }}</span>
                                                            </li>
                                                            <li>{{ $trend->release_year }}</li>
                                                        </ul>
