...
<section class="gen-section-padding-3 gen-single-video">
    <div class="container">
        <div class="row no-gutters">
            ...
            @if(isset($movie))
                <h2 class="m-3 ">{{ $movie->title }}</h2>
                
                @if($movie->video_url)
                    <div class="col-lg-12">
                        <div class="gen-video-holder">
                            <iframe width="100%" height="550px" src="{{ $movie->video_url }}" frameborder="0" 
                            ...
                            <div class="gen-single-video-info">
                                <div class="container">
                                    <div class="movie-detail">
                                        <img src="{{ asset($movie->image_url) }}" alt="{{ $movie->title }}" style="height:700px">
            ...
            @if(isset($show))
                <h2 class="m-3 text-center">{{ $show->title }}</h2>
    
                @if($show->video_url)
                    <div class="col-lg-12">
                        <div class="gen-video-holder">
                            <iframe width="100%" height="550px" src="{{ $show->video_url }}" frameborder="0" 
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
                                    allowfullscreen>
                            </iframe>
                        </div>
                    ...
                    <div class="col-lg-12 col-md-6">
                        <div class="single-video">
                            <div class="gen-single-video-info">
                                <div class="container">
                                    <div class="movie-detail">
                                        <img src="{{ asset($show->image_url) }}" alt="{{ $show->title }}" style="height:700px">
...
<!-- Mirrored from template.gentechtreedesign.com/html/streamlab/red-html/single-videos.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 15:15:52 GMT -->
</html>