    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            @if(isset($movie))
                <div class="col-md-6">
                    <!-- Movie Image -->
                    <img src="{{ asset($movie->image_url) }}" alt="{{ $movie->title }}" class="img-fluid rounded shadow-lg">
                </div>
                <div class="col-md-6">
            ...
            @if(isset($show))
                <div class="col-md-6">
                    <!-- Show Image -->
                    <img src="{{ asset($show->image_url) }}" alt="{{ $show->title }}" class="img-fluid rounded shadow-lg">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-12">
                    <div class="gen-video-holder">
                        <iframe width="100%" height="550px" 
                                src="{{ $movie->video_url ?? $show->video_url }}" 
                                frameborder="0" 
