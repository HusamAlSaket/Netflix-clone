                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <a class="navbar-brand" href="#">
                                <img class="img-fluid logo" src="images/logo-1.png" alt="StreamLab Logo">
                            </a>
                                ...
                                <div id="gen-menu-contain" class="gen-menu-contain">
                                    <ul id="gen-main-menu" class="navbar-nav ml-auto">
                                        ...
                                        <li class="menu-item">
                                            ...
                                            <ul class="sub-menu">
                                                <li><a href="single-movie.html">Trending Now</a></li>
                                                <li><a href="single-movie.html">New Releases</a></li>
                                                <li class="menu-item menu-item-has-children">
                                                    <a href="#">Action</a>
                                                    <ul class="sub-menu">
                                                        <li><a href="single-movie.html">Superhero</a></li>
                                                        <li><a href="single-movie.html">Adventure</a></li>
                                                        <li><a href="single-movie.html">Military</a></li>
                                                    </ul>
                                                </li>
                                                <li class="menu-item menu-item-has-children">
                                                    <a href="#">Comedy</a>
                                                    <ul class="sub-menu">
                                                        <li><a href="single-movie.html">Romantic Comedy</a></li>
                                                        <li><a href="single-movie.html">Dark Comedy</a></li>
                                                    </ul>
                                                </li>
                                                <li><a href="single-movie.html">Horror</a></li>
                                                <li><a href="single-movie.html">Drama</a></li>
                                                <li><a href="single-movie.html">Romance</a></li>
                                                <li><a href="single-movie.html">Popular</a></li>
                                                <li><a href="single-movie.html">Top Rated</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-item">
                                            <a href="#">TV Shows</a>
                            ...
                            <div class="gen-header-info-box">
                                <div class="gen-menu-search-block">
                                    <a href="javascript:void(0)" id="gen-search-btn"><i class="fa fa-search"></i></a>
                                ...
                                <div class="gen-account-holder">
                                    ...
                                    <div class="gen-account-menu">
                                        <ul>
                                            <li><a href="log-in.html"><i class="fas fa-sign-in-alt"></i> Login</a></li>
                                            <li><a href="register.html"><i class="fa fa-user"></i> Register</a></li>
                                            <li><a href="library.html"><i class="fa fa-indent"></i> Library</a></li>
                                            <li><a href="upload-video.html"><i class="fa fa-upload"></i> Upload Video</a></li>
                                        </ul>
                                    </div>
                                </div>
